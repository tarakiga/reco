...
export const FEATURES: Feature[] = [
  ...
  { category: "track", emoji: "❤️", name: "Favourites", blurb: "Heart titles straight from the grid, no need to open them first.", where: "Any card, or your Favourites", href: "/account" },
  { category: "track", emoji: "📔", name: "Watch diary", blurb: "Log what you watched and when, like a film diary. Rewatches welcome.", where: "Title pages and your Diary", href: "/account" },
  { category: "track", emoji: "🏷️", name: "Tags & collections", blurb: "Label titles with your own private tags, then turn any tag into a list.", where: "Title pages and your Tags", href: "/account" },
  { category: "track", emoji: "📝", name: "Shareable lists", blurb: "Build ranked lists with notes and share them with a rich preview card.", where: "Your Lists", href: "/account" },

  // Your stats
  { category: "stats", emoji: "🏆", name: "Completion tracking", blurb: "See how much of a franchise, or a director's and writer's work, you've watched.", where: "Movie and person pages, and your Completion tab", href: "/account", isNew: true },
  { category: "stats", emoji: "🗓️", name: "Coming up + calendar sync", blurb: "A personal TV schedule built from your watchlist, subscribable to Google Calendar.", where: "Your Coming up tab", href: "/account" },
  { category: "stats", emoji: "🎚️", name: "Taste profile", blurb: "Set your region and favourite genres to sharpen every recommendation.", where: "Account settings", href: "/account" },

  // Watch together
  { category: "together", emoji: "🗳️", name: "Vote to Watch", blurb: "Create a group poll, friends vote with no signup, and a two-round runoff settles what you all watch.", where: "Your Vote tab", href: "/account", isNew: true },
  ...
  // On every title
  { category: "title", emoji: "📡", name: "Where to watch", blurb: "See the streaming services a title is on in your region.", where: "Any title page", href: "/movies" },
  { category: "title", emoji: "▶️", name: "Trailers", blurb: "Watch the trailer right on the page.", where: "Any title page", href: "/movies" },
  { category: "title", emoji: "🎬", name: "Cast & crew", blurb: "Clickable cast and crew, with full-series cast for TV shows.", where: "Any title page", href: "/movies" },
  { category: "title", emoji: "🔭", name: "Episode finder", blurb: "Find any episode and read synopses season by season.", where: "Any TV show page", href: "/tv" },
  { category: "title", emoji: "🧬", name: "Collections & related", blurb: "Jump to sequels, spinoffs, remakes and similar titles.", where: "Any title page", href: "/movies" },
  { category: "title", emoji: "🥇", name: "Awards", blurb: "Oscars and Emmys on the people behind your favourites.", where: "Any person page", href: "/movies" },
];
