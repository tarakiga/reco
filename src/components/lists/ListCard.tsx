    ...
    <div className="rounded-lg border border-border bg-surface-raised p-3 sm:p-4">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-wrap items-baseline gap-x-2">
          ...
          <Link href={item.href} className="text-base font-semibold text-text transition-colors hover:text-accent-text">
            {item.title}
          </Link>
      ...
      {item.note && (
        <div className="mt-3 flex gap-2 rounded-md bg-accent/5 px-3 py-2.5">
          <svg viewBox="0 0 24 24" className="mt-0.5 size-4 shrink-0 text-accent-text" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
